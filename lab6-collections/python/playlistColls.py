...
piecesFromThings = [i for i in things if type(i) is Piece]
...
shortItemLenghts1 = [i.length_secs for i in playlist1 if i.length_secs < 20] # TASK 6.3.(b) -- replace "todo" by a list comprehension
